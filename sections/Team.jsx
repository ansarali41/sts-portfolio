const teamMembers = [
  {
    ...
    skills: ["Javascript", "TypeScript", "React.js", "Next.js", "Node.js", "Express.js", "Nest.js", "MySQL", "MongoDB", "Microservices"]
  },
  {
    name: "Md. Samim Hossain",
    role: "Full Stack Developer",
    skills: ["HTML5", "CSS3", "Bootstrap", "JavaScript", "Java", "Spring Boot", "C#", ".NET MVC", "MySQL", "PostgreSQL"]
  },
  {
    name: "Ashik Mahmud",
    role: "Full Stack Developer",
  ...
  },
  {
    ...
    skills: ["React.js", "Next.js", "Express.js", "JavaScript", "TypeScript", "Tailwind", "Bootstrap"]
  },
  {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Meet our talented team of developers and engineers who make the magic happen
          </p>
        </div>
            ...
            <div key={index} className="bg-gray-900 p-6 rounded-lg border border-gray-700 hover:border-blue-500 transition-colors">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {member.skills.length > 5 && (
                  <span className="text-gray-400 text-sm">+{member.skills.length - 5} more</span>
                )}
              </div>
            </div>
          ))}
