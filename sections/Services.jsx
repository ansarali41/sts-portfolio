const services = [
  {
    ...
    description:
      "Full-stack web development using modern technologies like React, Next.js, Node.js, and more.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Scalable enterprise applications using Java, Spring Boot, and .NET technologies.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Cloud infrastructure and microservices architecture implementation.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Database design and implementation with MySQL, MongoDB, PostgreSQL, and MS SQL.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    title: "UI/UX Design",
    description:
      "Modern and responsive design implementation with the latest frontend technologies.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              {/* Gradient Background */}
              <div
                className={`absolute inset-0 opacity-0 group-hover:opacity-10 transition-opacity duration-300 rounded-2xl bg-gradient-to-r ${service.gradient}`}
              ></div>
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-semibold mb-3 text-white group-hover:bg-clip-text group-hover:bg-gradient-to-r ${service.gradient}">
                  {service.title}
                </h3>
